...
export const API_NOTIFICATIONS_GET = '/api/notifications/get'
export const API_NOTIFICATIONS_UPDATE = '/api/notifications/update'
export const API_REVIEWS_GET = '/api/reviews/get'
