...
const AboutTitle = () => {
    ...
    return <LFFormSection sectionTitle={'About Page'}>
        <div className="lg:flex-grow md:w-1/2 pr-4">
            {title && <LFFormElement labelValue='Title' labelName='title'>
            ...
            {subTitle && <LFFormElement labelValue='Sub-title' labelName='subTitle'>
        ...
        <div className="lg:flex-grow md:w-1/2">
            {paragraph && <LFFormElement labelValue='Paragraph' labelName='paragraph'>
            ...
            {description && <LFFormElement labelValue='Description' labelName='description'>
